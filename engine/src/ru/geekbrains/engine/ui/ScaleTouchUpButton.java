...
/**
 * Кнопка на экране меню
 */
public class ScaleTouchUpButton extends Sprite {
     ...
     */
    public ScaleTouchUpButton(TextureRegion region, ActionListener listener, float pressScale) {
        super(region);
